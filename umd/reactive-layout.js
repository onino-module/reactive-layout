...
/* harmony import */ var is_plain_object__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
/* harmony import */ var stylis_rule_sheet__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
...
/* harmony import */ var react_is__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8);
...
var bg_default = __webpack_require__(6);
...
var styled_components_browser_es = __webpack_require__(2);
...
var Tabs = styled_components_browser_es["b" /* default */].div(_templateObject7, isPc("flex", "none"));

var Tab = styled_components_browser_es["b" /* default */].div(_templateObject8, function (_ref3) {
  var theme = _ref3.theme;
...
// EXTERNAL MODULE: ./src/reactive-layout/themes/app.css
...
var texts_fr = __webpack_require__(12);

// EXTERNAL MODULE: ./src/reactive-layout/data/texts-en.json
var texts_en = __webpack_require__(13);
...
var with_theme_withTheme = function withTheme(userTheme) {
  return function (Wrapped) {
    var Result = function (_Component) {
      ...
      function Result(props) {
        ...
        _this.computeStyles = function () {
          _this.setState({ options: with_theme_extends({}, compute_options()) });
        };

        var _colors = userTheme.colors || colors;
        _this.state = {
          colors: _colors,
          options: with_theme_extends({}, compute_options())
        };
        return _this;
      }
      ...
      Result.prototype.render = function render() {
        var theme = with_theme_extends({ colors: this.state.colors }, this.state.options);
        return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
          styled_components_browser_es["a" /* ThemeProvider */],
          { theme: theme },
          external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(Wrapped, with_theme_extends({}, this.props, { theme: theme }))
        );
      };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "withTheme", function() { return src_withTheme; });
